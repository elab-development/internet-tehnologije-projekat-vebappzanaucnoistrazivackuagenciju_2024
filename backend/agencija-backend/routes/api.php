...
Route::post('/publications/saveFullPublicationInfoDeleteAndStore', [PublicationController::class,'saveFullPublicationInfoDeleteAndStore'])->middleware(['auth:sanctum', 'ability:admin']);
Route::put('/publications/updateFullPublicationInfoDeleteAndStore', [PublicationController::class,'updateFullPublicationInfoDeleteAndStore'])->middleware(['auth:sanctum', 'ability:admin']);
...
Route::get('/references/filterByPublicationIdAndRefId', [ReferenceController::class,'filterByPublicationIdAndRefId']);
